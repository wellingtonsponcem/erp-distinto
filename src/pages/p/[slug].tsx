    ...
    return (
      <>
        <Head>
          ...
          <style dangerouslySetInnerHTML={{ __html: `html{overflow:auto!important} body{overflow:auto!important; background:#0b0c10!important; font-family:"Plus Jakarta Sans",system-ui,sans-serif} .proposal-wrapper{height:auto!important; overflow:visible!important; scroll-snap-type:none!important} .proposal-frame{display:none!important} .btn-floating{display:none!important} ::selection{background:#f59e0b;color:#0b0c10} /* fallback Tailwind responsive hidden (sem CDN) */ .hidden{display:none!important} .inline-flex{display:inline-flex!important} .inline{display:inline!important} @media(min-width:640px){.sm\\:inline-flex{display:inline-flex!important}.sm\\:inline{display:inline!important}.sm\\:hidden{display:none!important}} @media(min-width:1024px){.lg\\:inline-flex{display:inline-flex!important}}` }} />
        </Head>
